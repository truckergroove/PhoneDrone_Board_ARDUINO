 ...
 switch(ch)
  {
    ...
    case 6:  OCR3C=pwm; break;  //ch6 = out7 rudder
    case 7:  OCR3B=pwm; break;  //ch7 = out8 throttle
...
void Init_PWM3(void)             //OUT6&7 for the throttle
{
  pinMode(2,OUTPUT);
  pinMode(3,OUTPUT);
  pinMode(4,OUTPUT);
