...
//    Serial.print(" Ch3:");   Serial.print(InputCh(3));
    ...
    if (adk.isReady()){
        Serial.print("\r\nNow our phone is connected succesfully:\n");
            ...
            //Serial.println(tempC2);             //send the data to the computer
      ...
      if (len > 0) {
          Serial.print(" msg[0]: ");
          Serial.print(msg1[0],DEC);
          Serial.print(" msg[1]: ");
          Serial.print(msg1[1],DEC);
          Serial.print(" msg[2]: ");
          Serial.print(msg1[2],DEC);
          Serial.print(" msg[3]: ");
          Serial.print(msg1[3],DEC);
...
//        Serial.print(offset3,DEC);
    ...
    OutputCh(6,InputCh(3)+offset2);   
    OutputCh(7,InputCh(2)+offset3);    
  } 
  else {
    OutputCh(0,InputCh(0));
    OutputCh(1,InputCh(1));  
    OutputCh(6,InputCh(3));    //rudd on output 7
    OutputCh(7,InputCh(2));    //throttle on output 8  
  }
//   Serial.print(" ");
...
//   OutputCh(6,InputCh(3));  
//   OutputCh(7,InputCh(2));   
}
