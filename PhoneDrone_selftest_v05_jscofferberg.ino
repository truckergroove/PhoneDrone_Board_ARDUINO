...
//    Serial.print("Ch0:");    Serial.print(InputCh(0));
    ...
    if (loopCount == 10){
      loopCount = 0;
        int ch0 = InputCh(7),  ch1 = InputCh(6),  ch2 = InputCh(5),  ch3 = InputCh(4);
...
void send_Airspeed_2Android()
{
            ...
            float P_static = 0;
            //Pressure = ((9.455833334608085 * pow(10, 3)) *(pow(V_out,7))) - ((2.258076713308813 * pow(10, 5)) *(pow(V_out,6))) + ((2.302273861935358 * pow(10, 6)) *(pow(V_out,5))) - ((1.299065303203855 * pow(10, 7))*(pow(V_out,4))) + ((4.380839335614555 * pow(10, 7)) *(pow(V_out,3))) - ((8.828969140875334 * pow(10, 7)) *(pow(V_out,2))) + ((9.846061413276893 * pow(10, 7)) *V_out) - (4.687451864302102 * pow(10, 7));
